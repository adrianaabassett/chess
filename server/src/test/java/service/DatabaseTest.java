...
public class DatabaseTest {
    ...
    public void logoutPositive() throws DataAccessException, BadRequest, UnauthorizedException, AlreadyTakenException {
        ...
        assertEquals(null,authDatabase.getAuth(auth.authToken()));
    ...
    public void createGamePositive() throws DataAccessException, UnauthorizedException, BadRequest, AlreadyTakenException {
        ...
        assertNotNull(gameDatabase.getGame(gameID));
    ...
    public void joinGamePositive() throws DataAccessException, BadRequest, UnauthorizedException, InvalidID, AlreadyTakenException {
        ...
        assertEquals(gameData.gameID(), gameDatabase.getGame(gameID).gameID());
    }
    ...
    public void clearPositive() throws DataAccessException {
        userDatabase.createUser(new UserData("chicken", "pumpkin", "halloween"));
        authDatabase.createAuth(new AuthData("candy", "corn"));
        int game = gameDatabase.createGame("orange");
        assertNotNull(userDatabase.getUser("chicken"));
        assertNotNull(authDatabase.getAuth("candy"));
        assertNotNull(gameDatabase.getGame(game));
        userDatabase.clear();
        authDatabase.clear();
        gameDatabase.clear();
        assertNull(userDatabase.getUser("chicken"));
        assertNull(authDatabase.getAuth("candy"));
        assertNull(gameDatabase.getGame(game));
